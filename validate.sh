...
docker run -it --rm -v ${PWD}:/repo/ shared0-samcontrol1-1-prd.eng.sfdc.net:5000/hypersam:pporwal-20161108_111225-214156f /sam/sam-manifest-builder --root='/repo/' -validateonly
