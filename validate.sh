...
docker run -it --rm -v ${PWD}:/repo/ shared0-samcontrol1-1-prd.eng.sfdc.net:5000/hypersam:pporwal-20161103_134849-ce3affd /sam/sam-manifest-builder --root='/repo/' -validateonly
