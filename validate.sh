...
docker run -it --rm -v ${PWD}:/repo/ shared0-samcontrol1-1-prd.eng.sfdc.net:5000/hypersam:pporwal-20161014_151902-f114d06 /sam/sam-manifest-builder --root='/repo/' -validateonly
