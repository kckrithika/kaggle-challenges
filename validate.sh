...
docker run -it --rm -v ${PWD}:/repo/ shared0-samcontrol1-1-prd.eng.sfdc.net:5000/sam-tools:xiao.zhou-20161010_165332-c49e306 /sam/sam-manifest-builder --root='/repo/' -validateonly
