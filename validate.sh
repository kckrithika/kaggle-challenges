...
docker run -it --rm -v ${PWD}:/repo/ shared0-samcontrol1-1-prd.eng.sfdc.net:5000/hypersam:thargrove-20161021_131549-d139768 /sam/sam-manifest-builder --root='/repo/' -validateonly
