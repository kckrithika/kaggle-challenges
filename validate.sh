...
docker run -it --rm -v ${PWD}:/repo/ shared0-samcontrol1-1-prd.eng.sfdc.net:5000/hypersam:prahlad.joshi-20161117_152828-7e1158d /sam/sam-manifest-builder --root='/repo/' -validateonly
