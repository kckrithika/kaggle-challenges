...
configDir: if slbimages.phase == "1" then (self.slbDir + "/config/" + $.dirSuffix) else (self.slbDir + "/config"),
logsDir: if slbimages.phase == "1" then (self.slbDir + "/logs/" + $.dirSuffix) else (self.slbDir + "/logs"),
