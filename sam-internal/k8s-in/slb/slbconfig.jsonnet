{
    ...
    perCluster: {
        ...
        internalIpRange:
            ...
            + {
                "prd-sdc": "10.231.187.0/24,10.254.230.0/23",
        ...
        reservedIps:
            ...
            + {
                ...
                "prd-sam": [
                  ...
                  "10.251.198.246/32",  # gatekeeper-dashboardlb.user-icepd.prd-sam.prd.slb.sfdc.net - Peijun Wu - https://computecloud.slack.com/archives/C42SAQVS9/p1556063807120000?thread_ts=1556038442.093300&cid=C42SAQVS9
