{
    ...
    roleBasedSecrets: (if slbimages.phaseNum <= 3 then true else false),
    ...
    getValidateVIPAssignmentSubnet():: (if slbimages.phaseNum != 3 && slbimages.hypersdn_build >= 1253 then [
