{
    ...
    slaRequiresHealthProbes: if slbimages.phaseNum <= 3 then true else false,
    stockIpvsModules: (if slbimages.hypersdn_build >= 1135 && slbimages.phaseNum <= 1 then true else false),
