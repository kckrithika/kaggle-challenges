                ...
                containers: [
                    {
                        ...
                        command: [
                            ...
                            "--k8sAPIServer=",
                            "--deploymentsToMonitor=slb-ipvs=" + slbconfigs.ipvsReplicaCount + ",slb-nginx-config-b=" + (if slbimages.phaseNum <= 3 then std.ceil(slbconfigs.nginxConfigReplicaCount / 2) else slbconfigs.nginxConfigReplicaCount),
                            "--minPercentHealthy=" + 1,
                        ],
