...
local slbconfigs = (import "slbconfig.jsonnet") + (if slbimages.phase == "1" || slbimages.phase == "2" || slbimages.phase == "3" then { dirSuffix:: "slb-dns-register" } else {});
local slbshared = (import "slbsharedservices.jsonnet") + (if slbimages.phase == "1" || slbimages.phase == "2" || slbimages.phase == "3" then { dirSuffix:: "slb-dns-register", configProcessorLivenessPort:: portconfigs.slb.slbConfigProcessorDnsLivenessProbeOverridePort } else {});
