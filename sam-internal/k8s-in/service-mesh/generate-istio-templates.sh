...
${BASH_SOURCE%/*}/../jsonnet/jsonnet fmt -i ${BASH_SOURCE%/*}/templates/istio-init-autogenerated/*.*sonnet
${BASH_SOURCE%/*}/../jsonnet/jsonnet fmt -i ${BASH_SOURCE%/*}/templates/istio-autogenerated/*.*sonnet
