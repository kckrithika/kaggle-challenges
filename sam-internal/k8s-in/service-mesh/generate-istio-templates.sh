...
rm ${BASH_SOURCE%/*}/templates/istio-init-autogenerated/*.jsonnet
mv /tmp/istio-upgrade/templates/* ${BASH_SOURCE%/*}/templates/istio-init-autogenerated/
...
rm ${BASH_SOURCE%/*}/templates/istio-autogenerated/*.jsonnet
mv /tmp/istio-upgrade/templates/* ${BASH_SOURCE%/*}/templates/istio-autogenerated/

# Format auto-generated jsonnets.
${BASH_SOURCE%/*}/../jsonnet/jsonnet fmt -i service-mesh/templates/istio-init-autogenerated/*.*sonnet
${BASH_SOURCE%/*}/../jsonnet/jsonnet fmt -i service-mesh/templates/istio-autogenerated/*.*sonnet
