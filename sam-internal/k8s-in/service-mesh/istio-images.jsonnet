...

{
  ...
  per_phase: {
    ...
    "0": $.per_phase["1"] {
       ...
       pilot: "ops0-artifactrepo2-0-prd.data.sfdc.net/docker-sfci-dev/sfci/servicemesh/istio-packaging/pilot:e4dd5b12752541b9258f23f43b93038253508883",
       proxy: "ops0-artifactrepo2-0-prd.data.sfdc.net/docker-sfci-dev/sfci/servicemesh/istio-packaging/proxy:e4dd5b12752541b9258f23f43b93038253508883",
       proxyinit: "ops0-artifactrepo2-0-prd.data.sfdc.net/docker-sfci-dev/sfci/servicemesh/istio-packaging/proxy_init:e4dd5b12752541b9258f23f43b93038253508883",
