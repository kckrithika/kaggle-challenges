...

{
    ...
    madkubRefresherContainer:: {
            ...
            args: [
              ...
              "--madkub-endpoint=%s" % if configs.estate == "gsf-core-devmvp-sam2-sam" then "https://$(MADKUBSERVER_SERVICE_HOST):32007" else "https://10.254.208.254:32007",  // Check madkubserver-service.jsonnet for why IP
