  ...
  webhooks: [
    {
      ...
      if configs.estate == "gsf-core-devmvp-sam2-sam" then {
        ...
        url: "https://sherpa-injector.%s.svc%s:17442/mutate" % [versions.injectorNamespace, if configs.estate == "gsf-core-devmvp-sam2-sam" then ".gsf-core-devmvp-sam2-samtest.mvp.sam.sfdc.net" else ("." + configs.dnsdomain)],
      },
      rules: [
        {
          apiGroups: [
