    ...
    template: {
      ...
      spec: configs.specWithKubeConfigAndMadDog {
        containers: [
          {
            name: "injector",
            image: versions.canaryInjectorImage,
            ...
            args: [
              ...
              "--image=%s" % versions["1"].sherpaImage,
              "--log-level=debug",
            ...
            if std.length(versions["1"].canarySherpaImage) > 0 then [
              "--canary-image=%s" % versions["1"].canarySherpaImage,
            ],
            env+: [
              {
