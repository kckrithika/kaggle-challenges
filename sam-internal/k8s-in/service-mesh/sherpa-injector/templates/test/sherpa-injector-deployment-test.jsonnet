        ...
        containers: [
          {
            ...
            args: [
              ...
              "--image=%s" % versions["2"].sherpaImage,
              "--log-level=debug",
            ...
            if std.length(versions["2"].canarySherpaImage) > 0 then [
              "--canary-image=%s" % versions["2"].canarySherpaImage,
            ],
            env+: [
              {
