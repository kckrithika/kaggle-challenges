  ...
  'composed-templates': {
    ...
    'master-deployment-pipeline-templates': {
      'service-master': {
        ...
        'pipeline-template': "service_master/service_master_01-02.j2",
        'pipeline-template-dev': "service_master/service_master_01-02.j2",
      ...
      'env-type-aggregate': {
        ...
        'pipeline-template': "env_type_aggregate/env_type_aggregate_01-02.j2",
        'pipeline-template-dev': "env_type_aggregate/dev_env_type_aggregate_01-02.j2",
      ...
      'fi-aggregate': {
        ...
        'pipeline-template': "fi_aggregate/fi_aggregate_01-02.j2",
        'pipeline-template-dev': "fi_aggregate/fi_aggregate_01-02.j2",
      ...
      'fd-aggregate': {
        ...
        'pipeline-template': "fd_aggregate/fd_aggregate_01-02.j2",
        'pipeline-template-dev': "fd_aggregate/fd_aggregate_01-02.j2",
      ...
      'cell-aggregate': {
        ...
        'pipeline-template': "cell_aggregate/cell_aggregate_01-02.j2",
        'pipeline-template-dev': "cell_aggregate/cell_aggregate_01-02.j2",
