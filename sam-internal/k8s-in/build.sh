...
for jdir in . sam sam/configs sam/templates sam/templates/rbac sdn sdn/templates slb slb/templates storage/templates flowsnake flowsnake/templates tnrp tnrp/templates service-mesh service-mesh/templates service-mesh/sherpa-injector/templates service-mesh/switchboard/templates service-mesh/zoobernetes/templates dva-collection dva-collection/templates topology-svc/templates; do
