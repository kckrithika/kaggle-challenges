...
for jdir in . sam sam/configs sam/templates sam/templates/rbac sdn sdn/templates slb slb/templates storage/templates flowsnake flowsnake/templates tnrp tnrp/templates service-mesh service-mesh/templates service-mesh/namespaces/templates service-mesh/sherpa-injector/templates service-mesh/switchboard/templates service-mesh/zoobernetes/templates dva-collection dva-collection/templates topology-svc/templates; do
...
./parallel_build.py --src=sam/templates/,sdn/templates/,slb/templates/,storage/templates/,tnrp/templates,dva-collection/templates,topology-svc/templates,service-mesh/templates,service-mesh/namespaces/templates,service-mesh/sherpa-injector/templates,service-mesh/switchboard/templates,service-mesh/zoobernetes/templates,casam/sequencer/templates  --out=../k8s-out/ --pools=../pools/ --estatefilter=$1 --labelfilterfile=samlabelfilter.json
