...
./parallel_build.py --src=sam/templates/,sdn/templates/,slb/templates/,storage/templates/,tnrp/templates,dva-collection/templates,topology-svc/templates,service-mesh/templates,service-mesh/sherpa-injector/templates,service-mesh/switchboard/templates --out=../k8s-out/ --pools=../pools/ --estatefilter=$1 --labelfilterfile=samlabelfilter.json
