...
# Public functions used for computing images only!
{
    ...
    do_override_based_on_tag(overrides, repo, image_name, tag):: (
        ...
        if (std.startsWith(tagAfterOverride, "ops0-artifactrepo") || std.startsWith(tagAfterOverride, "ops-artifactrepo") || std.startsWith(tagAfterOverride, "gcr.io") || std.startsWith(tagAfterOverride, "791719295754.dkr.ecr.us-east-2.amazonaws.com")) then
          tagAfterOverride
        else
