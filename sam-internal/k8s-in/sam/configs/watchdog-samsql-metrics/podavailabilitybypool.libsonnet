{
    ...
    sql: "select 'GLOBAL' as MinionPool, 'GLOBAL' as Kingdom, 'GLOBAL' as Kingdom, 'global' as Estate, 'sql.available.podStatus' as Metric, Running as Value, CONCAT('Ready=',Phase,',Running=',Running,',Total=',total) as Tags
          from (
          ...
          union all
          select UPPER(MinionPool) as MinionPool, UPPER(kingdom) as kingdom, 'GLOBAL' as Kingdom, 'global' as Estate, 'sql.available.podStatusPerMinionPool' as Metric, Running as Value, CONCAT('Ready=',Phase,',Running=',Running,',Total=',total) as Tags
          from (
