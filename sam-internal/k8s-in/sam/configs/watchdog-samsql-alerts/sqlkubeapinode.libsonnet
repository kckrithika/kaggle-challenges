{
        ...
        sql: "SELECT Name,
              ...
              WHERE Name LIKE '%kubeapi%' AND Ready !='True' AND
                 ...
                 (now() > STR_TO_DATE('2019-01-30', '%Y-%m-%d') OR Name != 'shared0-samkubeapi3-1-par.ops.sfdc.net') AND
                 (now() > STR_TO_DATE('2019-01-30', '%Y-%m-%d') OR Name != 'shared0-samkubeapi1-1-yhu.ops.sfdc.net')",
        }
