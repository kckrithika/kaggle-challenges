...

{
    ...
    overrides: {
        ...
        "prd,prd-samdev,node-controller,hypersam": "ops0-artifactrepo1-0-prd.data.sfdc.net/docker-sam/cbatra/hypersam:20180807_214822.93a734b7.dirty.cbatra-ltm1",
        "prd,prd-samdev,samcontrol,hypersam": "ops0-artifactrepo1-0-prd.data.sfdc.net/docker-sam/cbatra/hypersam:20180807_214822.93a734b7.dirty.cbatra-ltm1",
