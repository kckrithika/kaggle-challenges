...

{
    ...
    static: {
        ...
        k4aInitContainerImage: (
            # Unblock k4a in ia4 and ia5.
            if $.phaseNum <= 2 || kingdom == "ia4" || kingdom == "ia5" then "2857-49f61d7400b7330433a29b09783ca3e7c827d973"
            else "2778-29ee2fa3a4532165211b8adae39ecf04c451a410"
        ),
