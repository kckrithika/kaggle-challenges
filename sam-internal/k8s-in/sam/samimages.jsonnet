...

{
    ...
    overrides: {
        ...
        "chx,chx-sam,watchdog-filesystem,hypersam": "sam-0001812-10f710cd",
        "dfw,dfw-sam,watchdog-filesystem,hypersam": "sam-0001812-10f710cd",
        "frf,frf-sam,watchdog-filesystem,hypersam": "sam-0001812-10f710cd",
        "hnd,hnd-sam,watchdog-filesystem,hypersam": "sam-0001812-10f710cd",
        "iad,iad-sam,watchdog-filesystem,hypersam": "sam-0001812-10f710cd",
        "ord,ord-sam,watchdog-filesystem,hypersam": "sam-0001812-10f710cd",
        "par,par-sam,watchdog-filesystem,hypersam": "sam-0001812-10f710cd",
        "phx,phx-sam,watchdog-filesystem,hypersam": "sam-0001812-10f710cd",
        "syd,syd-sam,watchdog-filesystem,hypersam": "sam-0001812-10f710cd",
        "ukb,ukb-sam,watchdog-filesystem,hypersam": "sam-0001812-10f710cd",
        "wax,wax-sam,watchdog-filesystem,hypersam": "sam-0001812-10f710cd",
        "yhu,yhu-sam,watchdog-filesystem,hypersam": "sam-0001812-10f710cd",
        "yul,yul-sam,watchdog-filesystem,hypersam": "sam-0001812-10f710cd",
    },
