...
local build_command_sets = if std.objectHas(flowsnake_images.feature_flags, "update_canary_names") && std.objectHas(flowsnake_images.feature_flags, "add_local_canary") then {
    "flowsnake_v0.10.0": {
