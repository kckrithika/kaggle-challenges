...
local flowsnake_all_kes = (import "flowsnakeEstates.json").kingdomEstates + ["prd/prd-minikube-big-flowsnake", "prd/prd-minikube-small-flowsnake"];
{
    ...
    # no v1 in PCL
    is_v1_enabled: !self.is_public_cloud && kingdom != "ph2" && kingdom != "ia2" && estate != "prd-data-flowsnake_test" && estate != "prd-dev-flowsnake_iot_test" && self.deployment_region != "emea",
