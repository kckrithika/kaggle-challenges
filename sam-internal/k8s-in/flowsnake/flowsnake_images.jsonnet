...
local utils = import "util_functions.jsonnet";
{
    ...
    per_phase: {
        ...
        "1": {
            ...
            es_image_tag: "503",
            fleetService_image_tag: "jenkins-dva-transformation-flowsnake-platform-PR-619-7-itest",
            glok_image_tag: "472",
            ...
            version_mapping: {
                ...
                # only copy above to phase 2
                {
                  ...
                  "0.9.9-storage-test": "jenkins-dva-transformation-flowsnake-platform-PR-619-7-itest",
                },
                # ignore this section, require by std.manifestIni
                sections: {
                },
