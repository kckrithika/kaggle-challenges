    ...
    per_phase: {
        ...
        "1": self["2"] {
            image_tags+: {
                ...
                spark_operator_image_tag: "jenkins-dva-transformation-spark-on-k8s-operator-PR-25-1-itest",  # 06/24 image with the augmented operator instrumentation
            },
            feature_flags+: {
