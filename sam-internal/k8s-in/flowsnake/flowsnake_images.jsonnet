...
local utils = import "util_functions.jsonnet";
{
    ...
    per_phase: {
        ...
        "1": self.default_image_tags {
            ...
            fleetService_image_tag: "jenkins-dva-transformation-flowsnake-platform-PR-646-27-itest",
            ...
            version_mapping: {
                ...
                # only copy above to phase 2
                {
                  ...
                  khtest: "jenkins-dva-transformation-flowsnake-platform-PR-646-27-itest",
                },
                # ignore this section, require by std.manifestIni
                sections: {
                },
