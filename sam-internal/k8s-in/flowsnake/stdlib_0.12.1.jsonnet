# From https://github.com/google/jsonnet/blob/v0.12.1/stdlib/std.jsonnet
 ...
 */
{
  ...
  #local std = self, ## lorrin: Removed for backport so we can access native methods, such as type. Hopefully the old ones are sufficient.
