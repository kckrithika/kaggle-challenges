...

{
    ...
    samcontroldeployer: {
        ...
        "delete-orphans": flowsnakeconfig.autodeployer_deletes_orphans,
        "orphan-namespaces": (if !flowsnakeconfig.autodeployer_deletes_orphans then "flowsnake,default,kube-system" else "flowsnake,sam-system"),
