...
local split_webhook = std.objectHas(flowsnake_images.feature_flags, "madkub_injector_split");
...
if flowsnake_config.madkub_enabled then
{
    ...
    if split_webhook then [{
        ...
        name: "madkub-injector-update.flowsnake.sfdc.net",
        failurePolicy: "Fail",
        clientConfig: {
			# Bug in 1.9.7 requires this. This is the Infra CA Level 2 - not that it matters, because system roots include SFDC and can validate the webhook cert.
            caBundle: "",
