...
if ! watchdog.watchdog_enabled || ! std.objectHas(flowsnake_images.version_mapping.main, "0.11.0") || std.objectHas(flowsnake_images.feature_flags, "dynamic_watchdogs") then
"SKIP"
else
