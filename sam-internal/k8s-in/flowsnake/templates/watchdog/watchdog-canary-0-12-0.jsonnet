...
if !watchdog.watchdog_enabled || ! std.objectHas(flowsnake_images.version_mapping.main, "0.12.0") || std.objectHas(flowsnake_images.feature_flags, "dynamic_watchdogs") then
"SKIP"
else
                ...
                containers: [
                    {
                        ...
                        command: [
                            ...
                            "-cliCheckerCommandTarget=0.12.0",
