...
local configmap_data =
    {   "check-spark-operator.sh": if std.objectHas(flowsnake_images.feature_flags, "sok_watchdog_analysis")
            then importstr "spark-on-k8s-canary-scripts/watchdog-spark-on-k8s-v2.sh"
        ...
        [if std.objectHas(flowsnake_images.feature_flags, "sok_watchdog_analysis") then "analysis.py"]: importstr "spark-on-k8s-canary-scripts/watchdog-spark-on-k8s-analysis.py"
    };
