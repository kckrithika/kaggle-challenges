{
    ...
    testimages: {
        ...
        slb_image: configs.registry + "/" + "docker-release-candidate/tnrp/sdn/hypersdn:v-0000051-79039d3d",
    },
    ...
    estates: {
        ...
        "prd-sdc": {
            ...
            permissionInitContainer: $.testimages.permissionInitContainer,
            sdn_bird: $.testimages.sdn_bird,
            sdn_peering_agent: configs.registry + "/" + "docker-release-candidate/tnrp/sdn/hypersdn:v-0000062-f9b0ef9e",
            sdn_watchdog: configs.registry + "/" + "docker-release-candidate/tnrp/sdn/hypersdn:v-0000062-f9b0ef9e",
