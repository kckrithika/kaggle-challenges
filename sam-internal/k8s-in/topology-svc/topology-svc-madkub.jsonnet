  ...
  local certDirLookup = {
    cert1: {
      ...
      annotation: {
        ...
        superpod: null,
        role: 'topology-svc',
        san: ["topology.vip.core.test.us-central1.gcp.sfdc.net", "10.130.2.66", "10.130.2.77", "server.gcp-uscentral1.cluster.local", "server.dc1.consul"],
      },
    },
    'client-certs': {
      mount: {
    ...
    'server-certs': {
      ...
      annotation: {
        ...
        superpod: null,
        role: 'topology-svc',
        san: ["topology.vip.core.test.us-central1.gcp.sfdc.net", "10.130.2.66", "10.130.2.77", "10.131.33.22", "server.gcp-uscentral1.cluster.local", "server.dc1.consul"],
        ip: ["127.0.0.1"],
      },
    },
    'peer-certs': {
