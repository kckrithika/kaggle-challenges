...
local images = import "images.jsonnet",
    ...
    sdn_demo_watchdog: images.sdn_demo_watchdog,
    sdn_vault_agent: images.sdn_vault_agent,
    sdn_demo_emailsender: "sdn@salesforce.com",
    sdn_demo_emailrec: (if estate == "prd-sdc" then "vkarnati@salesforce.com" else "sdn@salesforce.com"),
