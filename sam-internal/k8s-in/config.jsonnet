...
local utils = import "util_functions.jsonnet",
    ...
    rcImtEndpoint: (if kingdom == "dfw" then "http://shared0-samminionreportcollector1-1-dfw.ops.sfdc.net:18443/v1/bark" else if kingdom == "prd" || kingdom == "frf" then "https://reportcollector-" + kingdom + ".data.sfdc.net:18443/v1/bark" else "https://ops0-health1-1-" + kingdom + "." + engOrOps + ".sfdc.net:18443/v1/bark"),
    ...
    sfdchosts_arg: (if kingdom == "prd" || kingdom == "frf" then "--hostsConfigFile=/sfdchosts/hosts.json" else {}),
