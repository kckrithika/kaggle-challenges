...

{
    ...
    per_phase: {
        ...
        "2": $.per_phase["3"] {
             fireflyintake: "476",
             fireflysecintake: "476",
             fireflycrawler: "476",
             fireflypackage: "476",
             fireflypackagefalcon: "476",
             fireflypackagespin: "476",
             fireflypackagestagger: "476",
             fireflypromotion: "476",
             fireflypullrequest: "476",
    ...
    fireflypackagefalcon: configs.registry + "/dva/firefly-package:" + $.per_phase[$.phase].fireflypackagefalcon,
    fireflypackagespin: configs.registry + "/dva/firefly-package:" + $.per_phase[$.phase].fireflypackagespin,
    fireflypackagestagger: configs.registry + "/dva/firefly-package:" + $.per_phase[$.phase].fireflypackagestagger,
