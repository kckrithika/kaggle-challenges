...
if firefly_feature_flags.is_rabbitmq_enabled then {
  ...
  data: {
    ...
    "definitions.json": std.toString(import "configs/firefly-rabbitmq-definitions.jsonnet"),
    "rabbitmq.conf": (importstr 'configs/firefly-rabbitmq.conf') % { domain: 'rabbitmq-set.firefly' },
  },
} else "SKIP"
